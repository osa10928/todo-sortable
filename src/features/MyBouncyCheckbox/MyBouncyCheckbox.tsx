...
import styles, { _textStyle } from "./MyBouncyCheckbox.style";
...
class MyBouncyCheckbox extends React.Component<IBouncyCheckboxProps, IState> {
    ...
    onPress = () => {
        ...
        if (!disableBuiltInState) {
            this.setState({ checked: !checked }, () => {
                this.props.onPress && this.props.onPress({checked: this.state.checked, dataKey: this.props.dataKey});
            });
        } else {
            this.props.onPress && this.props.onPress({checked: this.state.checked, dataKey: this.props.dataKey});
        }
...
export default MyBouncyCheckbox;
